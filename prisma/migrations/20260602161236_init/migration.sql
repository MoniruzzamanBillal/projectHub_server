...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_COMPLETED', 'PROJECT_CREATED', 'PROJECT_UPDATED', 'MEMBER_ADDED', 'COMMENT_ADDED', 'DEADLINE_APPROACHING', 'OVERDUE');

-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('PROJECT_CREATED', 'PROJECT_UPDATED', 'PROJECT_DELETED', 'TASK_CREATED', 'TASK_UPDATED', 'TASK_DELETED', 'TASK_ASSIGNED', 'TASK_STATUS_CHANGED', 'MEMBER_ADDED', 'MEMBER_REMOVED', 'COMMENT_ADDED');
